...
def write_txt(path: str, content: Union[str, List[str]], encoding: str = "utf-8", mode: str = "a+") -> None:
    ...
    --------
        ...
        content (Union[str, List[str]]): The content to write. Can be a single string or a list of strings.
        encoding (str): The encoding to use for writing the file (default: "utf-8").
        mode (str): The file mode for writing (default: "a+", append mode).
            Common modes:
    ...
    Raises:
    --------
        ValueError: If the content is neither a string nor a list of strings.
        Exception: For other unexpected errors during the write operation.
    """
